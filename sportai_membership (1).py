...
def get_membership_tiers() -> Dict:
    """Get membership tier configurations with Elite Tech"""
    return {
        'Bronze': {
            'monthly_fee': 29,
            'credits_included': 5,
            ...
            'guest_passes': 0,
            'member_count': 145,
            'tech_access': '❌ No tech access',
            'tech_fee_per_session': 25
        },
        'Silver': {
            'monthly_fee': 45,
            'credits_included': 10,
            ...
            'guest_passes': 2,
            'member_count': 328,
            'tech_access': '✅ Basic (7-day storage)',
            'tech_fee_per_session': 15
        },
        'Gold': {
            'monthly_fee': 75,
            'credits_included': 20,
            ...
            'guest_passes': 4,
            'member_count': 287,
            'tech_access': '✅ Advanced + AI (30-day)',
            'tech_fee_per_session': 10
        },
        'Platinum': {
            'monthly_fee': 125,
            'credits_included': 40,
            ...
            'guest_passes': 8,
            'member_count': 87,
            'tech_access': '✅ Full Suite (90-day)',
            'tech_fee_per_session': 5
        },
        'Elite Tech Add-on': {
            'monthly_fee': 99,
            'credits_included': 0,
            ...
            'guest_passes': 0,
            'member_count': 68,
            'tech_access': '✅ UNLIMITED (1-year storage)',
            'tech_fee_per_session': 0,
            'stackable': True,
            'description': 'Add to any tier for unlimited tech access'
        },
        'Elite Tech Standalone': {
            'monthly_fee': 149,
            'credits_included': 15,
            'booking_discount': 0.10,
            'priority_booking': True,
            ...
            'tech_access': '✅ UNLIMITED (1-year storage)',
            'tech_fee_per_session': 0,
            'description': 'Complete package for serious athletes'
        },
        'Team Elite Tech': {
            'monthly_fee': 499,
            'credits_included': 100,
            'booking_discount': 0.25,
            'priority_booking': True,
            'suite_access': True,
            'max_rollover': 50,
            'guest_passes': 0,
            'member_count': 12,
            'tech_access': '✅ Team Analytics + UNLIMITED',
            'tech_fee_per_session': 0,
            'description': 'Up to 25 athletes, team analytics dashboard',
            'max_athletes': 25
        }
    }
